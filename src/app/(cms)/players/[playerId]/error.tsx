...
/**
 * 5xx / 未預期錯誤邊界（spec 09 §5）。Next.js 慣例 client component（含 reset）。
 */
export default function Error({ error, reset }: { error: Error; reset: () => void }) {
  useEffect(() => {
    recordMetric('players.detail.error', { code: 'render_error' });
  }, [error]);
  ...
  return (
    ...
    >
      ...
      <p className="text-muted-foreground mt-1 text-sm">系統暫時無法載入此玩家，請稍後重試。</p>
