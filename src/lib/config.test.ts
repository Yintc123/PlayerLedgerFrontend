...
describe('config', () => {
  ...
  it('should throw when REDIS_HOST is missing', () => {
    ...
    expect(() => required('REDIS_HOST')).toThrow('Missing required environment variable: REDIS_HOST')
  })
  ...
  it('should throw when value exceeds maximum', () => {
    ...
    expect(() => optionalInt('API_TIMEOUT_MS', 20_000, { max: 25_000 })).toThrow('must be <= 25000')
  })
